...
export class EstruturaFinalCompleta1764085250491 implements MigrationInterface {
    name = 'EstruturaFinalCompleta1764085250491'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."usuario_role_enum" AS ENUM('Admin', 'Membro')`);
        await queryRunner.query(`CREATE TABLE "usuario" ("id_usuario" uuid NOT NULL DEFAULT uuid_generate_v4(), "nome" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "senha" character varying(255) NOT NULL, "telefone" character varying(20) NOT NULL, "departamento" "public"."usuario_departamento_enum" NOT NULL DEFAULT 'Operações', "cargo" "public"."usuario_cargo_enum" NOT NULL DEFAULT 'Assistente', "descricao" text, "role" "public"."usuario_role_enum" NOT NULL DEFAULT 'Membro', "ativo" boolean NOT NULL DEFAULT true, "avatar_url" character varying(255), "data_criacao" TIMESTAMP NOT NULL DEFAULT now(), "data_atualizacao" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_2863682842e688ca198eb25c124" UNIQUE ("email"), CONSTRAINT "PK_dd52716c2652e0e23c15530c695" PRIMARY KEY ("id_usuario"))`);
